...
正如瓦特和斯托加茨所发现的，只需要在网络中添加少许的随机连接，就可以使整个网络的平均距离极度减小。换句话说，随机连接作为捷径使得整个网络的不同部分连接起来了。节点只需要通过少数几步，就可以连接到任何一个节点。

对于病毒而言，它并不需要传播给某一个或一些特定的个体，只要能够创造随机传播就可以了。而，现今人们可以很容易相互接触，这为病毒创造了非常有利的条件。因此，只要易感者和感染者之间有捷径可循，病毒会竭尽所能，搜寻每条可能路径将自己传播出去。
